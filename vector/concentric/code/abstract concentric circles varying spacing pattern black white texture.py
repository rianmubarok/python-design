...
def draw():
    """
    Concentric circles with exponentially increasing spacing.
    Rings are tightly packed near the center and space out towards the edges.
    """
    fig, ax = setup_ax()
    ...
    save(fig, "abstract concentric circles varying spacing pattern black white texture")
