...
def abstract_parallel_lines_tapered_extreme_pattern_black_white_texture():
    fig, ax = setup_ax()
    n_lines = 30
    ...
    save(fig, "abstract parallel lines tapered extreme pattern black white texture")


if __name__ == "__main__":
    abstract_parallel_lines_tapered_extreme_pattern_black_white_texture()
