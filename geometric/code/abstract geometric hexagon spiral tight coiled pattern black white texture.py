...
def hexagon spiral tight coiled():
    """Heksagon spiral dengan belitan rapat dan dimensi terkompresi."""
    fig, ax = setup ax()

    cx, cy = 50.0, 50.0
    n hexagons = 120  # Lebih banyak heksagon
    spiral turns = 6.5  # Lebih banyak belitan
    ...
    for i in range(n hexagons):
        ...
        hex size = 0.6 + 3.0 * (t ** 1.3)  # Pertumbuhan lebih cepat
        ...
        alpha = 0.8 - 0.3 * t
        ax.plot(x hex, y hex, color="black", linewidth=lw, 
