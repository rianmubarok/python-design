...
def nested_rotating_squares_counter():
    ...
    save(fig, "abstract_nested_rotating_squares_counter_pattern_black_white_geometric_texture")


if __name__ == "__main__":
    nested_rotating_squares_counter()
