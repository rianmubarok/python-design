...
def abstract_parallel_lines_density_circle_small_pattern_black_white_texture():
    fig, ax = setup_ax()
    n_lines = 40
    ...
    save(fig, "abstract parallel lines density circle small pattern black white texture")


if __name__ == "__main__":
    abstract_parallel_lines_density_circle_small_pattern_black_white_texture()
